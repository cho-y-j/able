...
const navKeys = [
  ...
  { href: "/dashboard/analysis", key: "analysis" as const, icon: "I" },
  ...
  { href: "/dashboard/rankings", key: "rankings" as const, icon: "K" },
  { href: "/dashboard/intraday", key: "intraday" as const, icon: "W" },
  { href: "/dashboard/factors", key: "factors" as const, icon: "D" },
  { href: "/dashboard/patterns", key: "patterns" as const, icon: "E" },
